...
Here's an example:
  ...
  >> sorted_partition = [3]
  >> unsorted_partition = [2, 1, 9, 4, 7, 6, 5, 8, 0]
  ...
  >> sorted_partition = [2, 3]
  >> unsorted_partition = [1, 9, 4, 7, 6, 5, 8, 0]
  ...
  >> sorted_partition = [1, 2, 3]
  >> unsorted_partition = [9, 4, 7, 6, 5, 8, 0]
  ...
  >> array = [1, 2, 3, 9, 4, 7, 6, 5, 8, 0]
  >> sorted_partition = [1, 2, 3, 9]
  >> unsorted_partition = [4, 7, 6, 5, 8, 0]
